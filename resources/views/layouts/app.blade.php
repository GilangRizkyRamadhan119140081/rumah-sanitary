...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ url('img/logo_sanitary.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('img/logo_sanitary.png') }}">
