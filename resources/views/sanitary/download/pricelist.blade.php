                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-12">
                        <div class="breadcrumb__content p-relative z-index-1 text-center">
                            <h3 class="breadcrumb__title">Download Price List</h3>
                            <div class="breadcrumb__list" style="max-width: 650px; margin: 0 auto; text-align: justify;">
                                <span>Silahkan unduh price list produk Rumah Sanitary, temukan  informasi lengkap tentang harga terbaru untuk produk-produk yang kami tawarkan. Klik tombol di bawah ini untuk mengunduh daftar harga sekarang.</span>
                            </div>
                        </div>
                    </div>
                </div>
