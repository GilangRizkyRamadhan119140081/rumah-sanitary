                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-12">
                        <div class="breadcrumb__content p-relative z-index-1 text-center">
                            <h3 class="breadcrumb__title">Download Brosur</h3>
                            <div class="breadcrumb__list" style="max-width: 650px; margin: 0 auto; text-align: justify;">
                                <span>Silahkan unduh brosur produk dari Rumah Sanitary, temukan produk-produk sanitary terbaru, spesifikasi teknis, dan berbagai penawaran menarik yang tersedia. Klik tombol di bawah ini untuk mengunduh brosur kami sekarang.</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($brosurs as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->image)
                                                        <a href="{{ Storage::disk('s3')->url($item->image) }}">
