...
(function ($) {
	...
	// 		  <h4 class="tp-theme-header-title">Newus Theme Settings</h4>
	// 	   </div>
	...
	var slider = new Swiper('.tp-product-gallery-active', {
		slidesPerView: 4,
		spaceBetween: 15,
		loop: true,
		rtl: rtl_setting,
		pagination: {
			el: ".tp-gallery-slider-dot",
			clickable: true,
			renderBullet: function (index, className) {
				return '<span class="' + className + '">' + '<button>' + (index + 1) + '</button>' + "</span>";
			},
		...
		// Navigation arrows
		navigation: {
			nextEl: ".tp-gallery-slider-button-next",
			prevEl: ".tp-gallery-slider-button-prev",
		},
		breakpoints: {
			'1400': {
				slidesPerView: 4,
	...
	var slider = new Swiper('.tp-product-featured-active', {
		slidesPerView: 6,
		spaceBetween: 10,
		// loop: true,
		rtl: rtl_setting,
	...
	var slider = new Swiper('.tp-product-selling-active', {
		slidesPerView: 6,
		spaceBetween: 7,
		// loop: true,
		rtl: rtl_setting,
		pagination: {
			el: ".tp-selling-slider-dot",
			clickable: true,
			renderBullet: function (index, className) {
				return '<span class="' + className + '">' + '<button>' + (index + 1) + '</button>' + "</span>";
			},
		...
		// Navigation arrows
		navigation: {
			nextEl: ".tp-selling-slider-button-next",
			prevEl: ".tp-selling-slider-button-prev",
		},
		breakpoints: {
			'1400': {
				slidesPerView: 6,
	...
	var slider = new Swiper('.tp-product-diskon-active', {
		slidesPerView: 6,
		spaceBetween: 7,
		// loop: true,
		rtl: rtl_setting,
		pagination: {
			el: ".tp-diskon-slider-dot",
			clickable: true,
			renderBullet: function (index, className) {
				return '<span class="' + className + '">' + '<button>' + (index + 1) + '</button>' + "</span>";
			},
		...
		// Navigation arrows
		navigation: {
			nextEl: ".tp-diskon-slider-button-next",
			prevEl: ".tp-diskon-slider-button-prev",
		},
		breakpoints: {
			'1400': {
				slidesPerView: 6,
	...
	var slider = new Swiper('.tp-product-category-active', {
		slidesPerView: 6,
		spaceBetween: 7,
		loop: true,
		rtl: rtl_setting,
