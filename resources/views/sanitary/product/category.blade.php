            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-1.jpg"></div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-2.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-3.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-4.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-5.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-6.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-7.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-8.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-9.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-10.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-11.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
                                    <a href="shop.html">Tablets</a>
                                </h3>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                            <div class="tp-category-main-thumb include-bg transition-3"
                                data-background="assets/img/category/main/category-main-12.jpg"></div>
                            <div class="tp-category-main-content">
                                <h3 class="tp-category-main-title">
