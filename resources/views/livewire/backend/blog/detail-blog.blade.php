                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>{!! $blogDetail->kategori_blog->title !!} ?? ''</div>
                                            </td>
                                        </tr>
                                        {{-- <tr>
                                            <td style="font-weight: 700">Tags</td>
                                            <td>
                                                <div>{!! $blogDetail->tags_blog->title !!}</div>
                                            </td>
                                        </tr> --}}
                                        <tr>
                                                ...
                                                <div>
                                                    @if ($blogDetail->image)
                                                        <img src="{{ Storage::disk('s3')->url($blogDetail->image) }}"
                                                            alt='{{ $blogDetail->slug }}' class="img-thumbnail"
                                                            width="150">
                                                    @else
                                        ...
                                        <tr>
                                            <td style="font-weight: 700">Nama Penulis</td>
                                            <td>
                                                <div>{!! $blogDetail->created_by !!}</div>
                                            </td>
                                        </tr>
                                        {{-- <tr>
