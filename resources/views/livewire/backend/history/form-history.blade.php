        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('data-history') }}">{{ __('History')
                            }}</a></div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="history.years"
                                                class="form-control @error('history.years') is-invalid @enderror"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="history.title"
                                                class="form-control @error('history.title') is-invalid @enderror"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @elseif ($history->image)
                                                Current: <br>
                                                <img src="{{ Storage::disk('s3')->url($history->image) }}"
