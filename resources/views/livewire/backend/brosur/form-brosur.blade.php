        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('data-brosur') }}">{{ __('Brosur')
                            }}</a></div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="brosur.title"
                                                class="form-control @error('brosur.title') is-invalid @enderror"></textarea>
