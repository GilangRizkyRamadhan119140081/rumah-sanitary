    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('Selling Produk') }}</div>
            </div>
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills w-100" role="tablist">
                                ...
                                <li class="nav-pill ml-auto">
                                    @can('users.create')
                                    <a class="nav-link active" href="{{ route('create-selling-produk') }}"
                                        data-toggle="tooltip" title="{{ __('Add New') }}"><i class="fa fa-plus"
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="main" role="tabpanel"
                                    ...
                                    @livewire('backend.selling-produk.published-selling-produk')
