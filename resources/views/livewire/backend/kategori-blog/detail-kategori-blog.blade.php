    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('Kategori Blog') }}</div>
            </div>
                            ...
                            <div class="card-header">
                                <ul class="nav nav-pills w-100 mb-4" role="tablist">
                                    <li class="nav-pill ml-auto">
                                        <a class="nav-link active btn-sm" href="{{ route('data-kategori-blog') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td>
                                                <div>{!! $kategoriblog->title !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Gambar</td>
                                            <td>
                                                @if ($kategoriblog->image)
                                                    <img src='{{ Storage::disk('s3')->url($kategoriblog->image) }}'
                                                        alt='{{ $kategoriblog->slug }}' class='img-thumbnail'
                                                        width='150' />
                                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="badge badge-primary">{!! $kategoriblog->slug !!}</div>
                                            </td>
                                        </tr>
                                        @if ($kategoriblog->media !== null)
                                            <tr>
                                                <td style="font-weight: 700">Gambar</td>
                                                <td>
                                                    <div>
                                                        <img src="{{ Storage::disk('s3')->url($kategoriblog->media) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>{!! $kategoriblog->created_at !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Updated At</td>
                                            <td>
                                                <div>{!! $kategoriblog->updated_at !!}</div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
