        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('data-companyprofile') }}">{{ __('CompanyProfile')
                            }}</a></div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="companyprofile.title"
                                                class="form-control @error('companyprofile.title') is-invalid @enderror"></textarea>

                                            @error('companyprofile.title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                ...
                                                wire:model="file" aria-describedby="fileHelpId"
