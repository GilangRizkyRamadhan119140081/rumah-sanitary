                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <tr>
                                            <td style="font-weight: 700">Cabang 1</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="font-weight: 700">Cabang 2</td>
                                            <td>
                                                <div>{!! $detailKontak->alamat_cabang !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Latitude Cabang 2</td>
                                            <td>
                                                <div>{!! $detailKontak->lat_2 !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Longitude Cabang 2</td>
                                            <td>
                                                <div>{!! $detailKontak->lng_2 !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="font-weight: 700">No Telephone</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="font-weight: 700">Sekilas Kami</td>
                                            <td>
                                                <div>{!! $detailKontak->overview !!}</div>
                                            </td>
                                        </tr>
