                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <label for="">Cabang 2</label>
                                            <textarea wire:model="kontak.alamat_cabang"
                                                class="form-control @error('kontak.alamat_cabang') is-invalid @enderror"></textarea>

                                            @error('kontak.alamat_cabang')
                                            <span class='invalid-feedback'>
                                                <strong>{{ $message }} </strong>
                                            </span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <label for="">Latitude Cabang 2 <small class="text-danger">(Ambil titik melalui
                                                    google
                                                    maps)</small></label>
                                            <input type="text" placeholder="contoh: -5.402853097367839"
                                                class="form-control @error('kontak.lat_2') is-invalid @enderror"
                                                wire:model="kontak.lat_2">
                                            @error('kontak.lat_2')
                                            <span class='invalid-feedback'>
                                                <strong>{{ $message }} </strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            <label for="">Longitude Cabang 2<small class="text-danger">(Ambil titik melalui
                                                    google maps)</small></label>
                                            <input type="text" placeholder="contoh: 105.25843412555126"
                                                class="form-control @error('kontak.lng_2') is-invalid @enderror"
                                                wire:model="kontak.lng_2">
                                            @error('kontak.lng_2')
                                            <span class='invalid-feedback'>
                                                <strong>{{ $message }} </strong>
                                            </span>
                                        ...
                                        <div class="form-group">
                                            <label for="">Sekilas Kami</label>
                                            <textarea wire:model="kontak.overview"
                                                class="form-control @error('kontak.overview') is-invalid @enderror"></textarea>

                                            @error('kontak.overview')
                                            <span class='invalid-feedback'>
                                                <strong>{{ $message }} </strong>
                                            </span>
                                            @enderror
