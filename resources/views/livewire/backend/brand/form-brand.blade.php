        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('data-brand') }}">{{ __('Brand') }}</a>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="">Nama Brand <span class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('brand.title') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('brand.slug') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="brand.excerpt" class="form-control @error('brand.excerpt') is-invalid @enderror"></textarea>
                                        ...
                                        <div class="form-group" wire:ignore>
                                            ...
                                            <textarea name="" id="" style="height: 150px" class="form-control body"
                                                data-model="brand.deskripsi" wire:model="brand.deskripsi">{{ $brand ? $brand->deskripsi : '' }}
                                            </textarea>
                                        </div>
...
<script>
    CKEDITOR.ClassicEditor.create(document.querySelector('textarea.body'), {
        ...
        editor.model.document.on('change:data', () => {
            @this.set('brand.deskripsi', editor.getData());
        });
    })
</script>
@endpush
