    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('Kategori Label') }}</div>
            </div>
                            ...
                            <div class="card-header">
                                <ul class="nav nav-pills w-100 mb-4" role="tablist">
                                    <li class="nav-pill ml-auto">
                                        <a class="nav-link active btn-sm" href="{{ route('data-kategori-label') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td>
                                                <div>{!! $kategorilabel->title !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Slug</td>
                                            <td>
                                                <div class="badge badge-primary">{!! $kategorilabel->slug !!}</div>
                                            </td>
                                        </tr>
