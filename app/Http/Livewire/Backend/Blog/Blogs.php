...
class Blogs extends Component
{
    ...
    {
        return view('livewire.backend.blog.blogs');
    }
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            Blog::whereIn('id', $this->selectedItems)->delete();
        } else {
            Blog::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            Blog::where('id', $this->selectedItem)->delete();
        } else {
            Blog::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
