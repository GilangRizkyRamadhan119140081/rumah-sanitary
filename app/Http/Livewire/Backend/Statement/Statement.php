...
use App\Models\Statement as ModelsStatement;
...
class Statement extends Component
{
    ...
    {
        ModelsStatement::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsStatement::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsStatement::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsStatement::where('id', $this->selectedItem)->delete();
        } else {
            ModelsStatement::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
