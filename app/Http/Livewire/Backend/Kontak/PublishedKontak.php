...
class PublishedKontak extends DataTableComponent
{
    public function columns(): array
    {
        return [
            ...
            Column::make('No Telephone', 'phone_tr_1')->format(function ($value, $column) {
                return $value;
            })->asHtml(),
            Column::make('Cabang 1', 'alamat')->format(function ($value, $column) {
                return $value;
            })->asHtml(),
            Column::make('Cabang 2', 'alamat_cabang')->format(function ($value, $column) {
                return $value;
            })->asHtml(),
            Column::make('Sekilas Kami', 'overview')->format(function ($value, $column) {
                return $value;
            })->asHtml(),
