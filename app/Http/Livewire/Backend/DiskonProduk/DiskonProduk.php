...
use App\Models\DiskonProduk as ModelsDiskonProduk;
use Livewire\Component;

class DiskonProduk extends Component
{
    ...
    {
        return view('livewire.backend.diskonproduk.diskonproduk');
    }

    public function restore($id)
    {
        ModelsDiskonProduk::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsDiskonProduk::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsDiskonProduk::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsDiskonProduk::where('id', $this->selectedItem)->delete();
        } else {
            ModelsDiskonProduk::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
