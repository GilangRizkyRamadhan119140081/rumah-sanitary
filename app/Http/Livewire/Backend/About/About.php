...
class About extends Component
{
    ...
    {
        ModelsAbout::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsAbout::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsAbout::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsAbout::where('id', $this->selectedItem)->delete();
        } else {
            ModelsAbout::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
