...
use App\Models\FeaturedProduk as ModelsFeaturedProduk;
use Livewire\Component;

class FeaturedProduk extends Component
{
    ...
    {
        return view('livewire.backend.featuredproduk.featuredproduk');
    }

    public function restore($id)
    {
        ModelsFeaturedProduk::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsFeaturedProduk::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsFeaturedProduk::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsFeaturedProduk::where('id', $this->selectedItem)->delete();
        } else {
            ModelsFeaturedProduk::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
