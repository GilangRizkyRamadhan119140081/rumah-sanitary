...
class Banner extends Component
{
    ...
    {
        return view('livewire.backend.banner.banner');
    }

    public function restore($id)
    {
        ModelsBanner::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsBanner::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsBanner::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsBanner::where('id', $this->selectedItem)->delete();
        } else {
            ModelsBanner::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
