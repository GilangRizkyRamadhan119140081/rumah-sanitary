...
class Produk extends Component
{
    ...
    {
        return view('livewire.backend.produk.produk');
    }

    public function restore($id)
    {
        ModelsProduk::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsProduk::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsProduk::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsProduk::where('id', $this->selectedItem)->delete();
        } else {
            ModelsProduk::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
