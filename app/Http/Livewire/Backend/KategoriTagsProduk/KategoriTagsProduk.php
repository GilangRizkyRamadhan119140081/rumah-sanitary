...
use App\Models\KategoriTagsProduk as ModelsKategoriTagsProduk;
use Livewire\Component;

class KategoriTagsProduk extends Component
{
    ...
    {
        return view('livewire.backend.kategori-tags-produk.kategori-tags-produk');
    }

    public function restore($id)
    {
        ModelsKategoriTagsProduk::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsKategoriTagsProduk::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsKategoriTagsProduk::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsKategoriTagsProduk::where('id', $this->selectedItem)->delete();
        } else {
            ModelsKategoriTagsProduk::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
