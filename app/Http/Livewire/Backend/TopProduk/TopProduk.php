...
use App\Models\TopProduk as ModelsTopProduk;
...
class TopProduk extends Component
{
    ...
    {
        return view('livewire.backend.topproduk.topproduk');
    }

    public function restore($id)
    {
        ModelsTopProduk::withTrashed()->find($id)->restore();
    ...
    public function deleteSelected()
    {
        ...
        if ($this->force === false) {
            ModelsTopProduk::whereIn('id', $this->selectedItems)->delete();
        } else {
            ModelsTopProduk::onlyTrashed()->whereIn('id', $this->selectedItems)->forceDelete();
        }
        $this->clear();
    ...
    {
        if ($this->force === false) {
            ModelsTopProduk::where('id', $this->selectedItem)->delete();
        } else {
            ModelsTopProduk::onlyTrashed()->find($this->selectedItem)->forceDelete();
        }
